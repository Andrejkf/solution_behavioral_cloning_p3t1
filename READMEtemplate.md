...
* Learning rate: given the fact I used Adam optimizer starting with fixed learning rate it was adjusted by keras.
* batch size:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzg3NzY0NjUsLTEyNjY3MzgyNDcsMT
