...
So basically, during the whole desing process more and more images where added to build up the training and validation data set. Ending with a set of 16235 images. 80 % of them used as initial training data set and the remaining 20% for validation. It is important to say that 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExOTc0MTE0NzEsLTE0NTA5MjgzNjcsLT
