...
The total data used in this project is a union between *data provided by udacity* and *data collected by the student using the [simulator provided by udacity](https://github.com/udacity/self-driving-car-sim).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwNjIxNTg2LDE5MTI5NjIzODIsNDY3Nz
E5OTI4XX0=
-->