...
In   I used a very similar model to the [nvidia model](https://images.nvidia.com/content/tegra/automotive/images/2016/solutions/pdf/end-to-end-dl-using-px.pdf)  including dropout layers and also adding L2 regularization technique to avoid overfitting. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTY1NjY4Nzk2LDE0MzkxMjY0MDUsMTExNz
