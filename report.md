...
On the seccond stage to get a better distribuion, closer to a guassian one, the same threshold value was defined (again,  threshold = 1.5*average).  A vector  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTAwNDc1Miw2OTY1MDAwNCw3OTQwND
