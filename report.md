...
* brigth_augmentation2(): (Code lines 468 - 479) used to shift sligthly the image brigth in HSV color space using a random
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjU0NDAwMzYsLTgzNTU0MDMwMywxND
