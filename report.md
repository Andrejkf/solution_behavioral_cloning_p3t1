...
Funtion get_list_pos() and find_pos() were defined to get the position of the path o the redundant images (code lines 138 to 193). Funtion my_hist() was designed just to understand how to filter 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODA0MDQ5NTQ5LDY5NjUwMDA0LDc5NDA0Nz
