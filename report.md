...
* A folder named **model_and_videos_v0** with the short version of the videos for track1 and track2 with the behavioral for the version zero( of the model designed.  [This is the link for full video *track1 model_v0*](https://youtu.be/QSoAm0VID_E) and [This is the link for full video *track2 model_v0*](https://youtu.be/LIIXsI2CnoQ).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzMjkxNDE2OCwtMTIxNzcyMjAxMiwxMD
E1ODI4ODQzXX0=
-->