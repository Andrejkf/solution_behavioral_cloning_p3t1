...
* Two folders named **model_and_videos_v0** and **model_and_videos_v1** with **short version of the videos** videos for track1, track2, and their corresponding *model.h* and  *drive.py* files that you may want to use to run them in your local machine. This alre the links for the full videos: [track1_v0]()
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5ODEyMTIxNDYsMTAxNTgyODg0M119
-->